    ...
    <form class="form form-vertical" method="POST" action="#" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="col-sm-10">
                        <input id="employeeid" type="text" name="employID" class="form-control" value="<?= $row['employID'] ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="col-sm-10">
                        <input id="supplierID" type="text" name="supplierID" class="form-control" value="<?= $row['supplierID'] ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="col-sm-10">
               <input id="image" type="text" name="img" class="form-control" value="<?= $row['img'] ?>" required>
                    </div>
                </div>
            </div>
